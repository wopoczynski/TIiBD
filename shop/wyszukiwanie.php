...
END;
    ...
    <div class = "kafelek">
      ...
      <div class="pole2">
      <center>Wyszukiwarka zaawansowana</center><br /><br />
          <form action="wyniki.php" method="post">

            <center><input type="text" name="fraza" size=40 /></center>
            <center><input type="submit" value="Wyszukaj" name="adv" /></center>
            <br /><br />
            Kategoria:<br /><br />
            <select name="kategoria">
            <option value=0>Wszystkie</option>
            <option value=1>Sprzęt laboratoryjny</option>
            <option value=2>Odczynniki</option>
			<option value=3>Mikrobiologia</option>
            (...)
          </select><br /><br /><br />
          Przedział cenowy:<br /><br />
          Od: <input type="text" name="ile" size=10/>
          Do: <input type="text" name="ile2" size=10 /> zł
          </form>
